...
export const CLIENTS: ClientGroup[] = [
  { sector: 'Mining & energy', names: [
    ...
    { name: 'Barloworld Zambia', logo: '/logos/barloworld.webp', w: 228, h: 53, height: 26 },
    { name: 'Caterpillar', logo: '/logos/caterpillar.svg', w: 112, h: 20, height: 18 },
    { name: 'ZIMEC', logo: '/logos/zimec.webp', w: 260, h: 135, height: 38 },
  ] },
  ...
  { sector: 'Development & climate', names: [
    { name: 'USAID', years: '2022 – 2023', logo: '/logos/usaid.webp', w: 320, h: 96, height: 26 },
    { name: 'Dialogue Earth', logo: '/logos/dialogue-earth.svg', w: 200, h: 32, height: 16 },
  ] },
  { sector: 'Government & infrastructure', names: [
    { name: 'Office of the President', logo: '/logos/zambia-coat-of-arms.webp', w: 100, h: 116, height: 46 },
    { name: 'Zambia Airports', logo: '/logos/zambia-airports.webp', w: 151, h: 72, height: 38 },
  ] },
  { sector: 'Agribusiness', names: [
    { name: 'Zambeef', logo: '/logos/zambeef.webp', w: 174, h: 124, height: 46 },
    { name: 'Novatek', logo: '/logos/novatek.webp', w: 520, h: 190, height: 32 },
  ] },
]
